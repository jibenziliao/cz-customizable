...
const isNotWip = (answers) => answers.type && answers.type.toLowerCase() !== 'wip';
      ...
      ...(config.additionalQuestions || []),
      {
        ...
        when(answers) {
          ...
          if (
            ...
            (config.allowBreakingChanges && config.allowBreakingChanges.includes(answers.type.toLowerCase()))
          ) {
            return true;
          }
